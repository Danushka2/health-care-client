...
!function webpackUniversalModuleDefinition(root, factory) {
    ...
    return function (modules) {
        ...
        var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) {
            ...
            }, $ = __webpack_require__(4), window = __webpack_require__(6), document = window.document,
        ...
        function maskScope(actionObj, maskset, opts) {
            ...
            function alternate(pos, c, strict, fromSetValid, rAltPos) {
                ...
                if (-1 === lAltPos && void 0 === rAltPos) lastAlt = 0, prevAltPos = getTest(lastAlt), alternation = prevAltPos.alternation; else for (; 0 <= lAltPos; lAltPos--) if (altPos = getMaskSet().validPositions[lAltPos], altPos && void 0 !== altPos.alternation) {
                ...
                function _isValid(position, c, strict) {
                    ...
                    return $.each(getTests(position), function (ndx, tst) {
                        ...
                        if (getBuffer(!0), rslt = null != test.fn ? test.fn.test(c, getMaskSet(), position, strict, opts, isSelection(pos)) : (c === test.def || c === opts.skipOptionalPartCharacter) && "" !== test.def && {
                            ...
                            })), !0 !== rslt && void 0 !== rslt.pos && rslt.pos !== position && (validatedPos = rslt.pos), !0 !== rslt && void 0 === rslt.pos && void 0 === rslt.c ? !1 : (revalidateMask(pos, $.extend({}, tst, {input: casing(elem, test, validatedPos)}), fromSetValid, validatedPos) || (rslt = !1), !1)
                        }
                    }), rslt
                }
                ...
                if ($.isFunction(opts.preValidation) && !strict && !0 !== fromSetValid && !0 !== validateOnly && (result = opts.preValidation(getBuffer(), maskPos, c, isSelection(pos), opts, getMaskSet())), !0 === result) {
                    if (trackbackPositions(void 0, maskPos, !0), (void 0 === maxLength || maskPos < maxLength) && (result = _isValid(maskPos, c, strict), (!strict || !0 === fromSetValid) && !1 === result && !0 !== validateOnly)) {
                        ...
                        if (!currentPosValid || null !== currentPosValid.match.fn || currentPosValid.match.def !== c && c !== opts.skipOptionalPartCharacter) {
                            if ((opts.insertMode || void 0 === getMaskSet().validPositions[seekNext(maskPos)]) && (!isMask(maskPos, !0) || getMaskSet().jitOffset[maskPos])) if (getMaskSet().jitOffset[maskPos] && void 0 === getMaskSet().validPositions[seekNext(maskPos)]) result = isValid(maskPos + getMaskSet().jitOffset[maskPos], c, strict), !1 !== result && (result.caret = maskPos); else for (var nPos = maskPos + 1, snPos = seekNext(maskPos); nPos <= snPos; nPos++) if (result = _isValid(nPos, c, strict), !1 !== result) {
                    ...
                    !1 !== result || !1 === opts.keepStatic || null != opts.regex && !isComplete(getBuffer()) || strict || !0 === fromAlternate || (result = alternate(maskPos, c, strict, fromSetValid)), !0 === result && (result = {pos: maskPos})
                }
            ...
            function trackbackPositions(originalPos, newPos, fillOnly) {
                ...
                for (var ps = originalPos; ps < newPos; ps++) if (void 0 === getMaskSet().validPositions[ps] && !isMask(ps, !0)) {
                    ...
                    if (vp) {
                        ...
                        if (bestMatch = $.extend({}, bestMatch, {input: getPlaceholder(ps, bestMatch.match, !0) || bestMatch.match.def}), bestMatch.generatedInput = !0, revalidateMask(ps, bestMatch, !0), !0 !== fillOnly) {
            ...
            function checkVal(input, writeOut, strict, nptvl, initiatingEvent) {
                ...
                -1 === initialNdx ? (getMaskSet().p = seekNext(initialNdx), initialNdx = 0) : getMaskSet().p = initialNdx, inputmask.caretPos = {begin: initialNdx}, $.each(inputValue, function (ndx, charCode) {
            ...
            numeric: {
                ...
                onBeforeWrite: function onBeforeWrite(e, buffer, caretPos, opts) {
                    ...
                    if (e) switch (e.type) {
                        ...
                        case"checkval":
                            var unmasked;
                            parseMinMaxOptions(opts), null === opts.min && null === opts.max || (unmasked = opts.onUnMask(buffer.join(""), void 0, $.extend({}, opts, {unmaskAsNumber: !0})), null !== opts.min && unmasked < opts.min ? (this.value = opts.min, $(this).trigger("setvalue")) : null !== opts.max && unmasked > opts.max && (this.value = opts.max, $(this).trigger("setvalue")))
                    }
                },
                definitions: {
                    "+": {
