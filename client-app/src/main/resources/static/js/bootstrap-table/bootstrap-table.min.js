...
(function (e, t) {
    ...
    var S, x, k,
        ...
        ce = "function" == typeof re && /native code/.test(le.call(re)), de = 0, O = Math.random(),
        pe = function (e) {
    ...
    var xe = {
        ...
        }, ze = Ue.data = {}, Ge = Ue.NATIVE = "N", We = Ue.POLYFILL = "P", Ye = Ue, Ke = Z.f,
        Xe = function (e, t) {
            ...
            return e
        }, ot = Oe("document", "documentElement"), at = he("IE_PROTO"), nt = "prototype",
        it = function () {
        }, st = function () {
    ...
    var rt = Le.f, ct = {}.toString,
        ...
        pt = function (e) {
            ...
            find: Ct(5),
            findIndex: Ct(6)
        }, $t = It.forEach, At = he("hidden"), Et = "Symbol", Rt = "prototype", _t = ft("toPrimitive"),
        Nt = xe.set, Ft = xe.getterFor(Et), Dt = Object[Rt], Lt = C.Symbol, Vt = C.JSON,
        Bt = Vt && Vt.stringify, Ht = Z.f, jt = ae.f, Mt = ut.f, Ut = f.f, qt = se("symbols"),
    ...
    Qe || (Lt = function () {
        ...
        var e = arguments.length && void 0 !== arguments[0] ? arguments[0] + "" : void 0, t = pe(e),
            o = function (e) {
    ...
    var Ko = {IteratorPrototype: Ho, BUGGY_SAFARI_ITERATORS: Yo}, Xo = Ko.IteratorPrototype,
        Qo = function (e, t, o) {
        ...
        }() : void 0), ea = Ko.IteratorPrototype, ta = Ko.BUGGY_SAFARI_ITERATORS, oa = ft("iterator"),
        aa = "keys", na = "values", ia = "entries", sa = function () {
            return this
    ...
    var xa = function (e, t, o) {
        ...
        ka = "\t\n\x0B\f\r \xA0\u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u202F\u205F\u3000\u2028\u2029\uFEFF",
        Ta = "[" + ka + "]", Pa = RegExp("^" + Ta + Ta + "*"), Oa = RegExp(Ta + Ta + "*$"),
        Ca = function (e) {
            return function (t) {
                var o = H(t) + "";
                return 1 & e && (o = o.replace(Pa, "")), 2 & e && (o = o.replace(Oa, "")), o
            }
        }, Ia = {start: Ca(1), end: Ca(2), trim: Ca(3)}, $a = Le.f, Aa = Z.f, Ea = ae.f,
        Ra = Ia.trim, _a = "Number", Na = C[_a], Fa = Na.prototype, Da = L(lt(Fa)) == _a,
        La = function (e) {
    ...
    var ln = Ia.trim, rn = C.parseInt, cn = /^[+-]?0[Xx]/,
        dn = 8 !== rn(ka + "08") || 22 !== rn(ka + "0x16"), pn = dn ? function (e, t) {
            var o = ln(e + "");
    ...
    var ui = {
        3: {
            ...
            html: {
                ...
                searchInput: "<input class=\"%s%s\" type=\"text\" placeholder=\"%s\">",
                searchButton: "<button class=\"btn btn-primary\" type=\"button\" name=\"search\" title=\"%s\">%s %s</button>",
    ...
    Xe({target: "Array", proto: !0}, {
        flat: function () {
            var e = arguments.length ? arguments[0] : void 0, t = Ze(this), o = Ie(t.length),
                a = Pt(t, 0);
    ...
    var yi = {
        ...
        return s(e, [{
            key: "initDOM", value: function (e) {
                ...
                var t = this.initData(e, this.getNum()), o = t.rows.join(""),
                    a = this.checkChanges("data", o), n = this.checkChanges("top", t.topOffset),
            ...
            key: "initData", value: function (e, t) {
                ...
                var o = b((this.clusterRows - wi) * t, 0), a = o + this.clusterRows,
                    n = b(o * this.itemHeight, 0), s = b((e.length - a) * this.itemHeight, 0),
                    l = [], r = o;
                1 > n && r++;
        ...
        return s(e, [{
            ...
            key: "initHeader", value: function () {
                ...
                this.header = {
                    ...
                    n.push("<tr>"), 0 === t && !o.options.cardView && o.options.detailView && o.options.detailViewIcon && n.push("<th class=\"detail\" rowspan=\"".concat(o.options.columns.length, "\">\n          <div class=\"fht-cell\"></div>\n          </th>\n        ")), e.forEach(function (e, i) {
                        if (e.visible) {
                            var s = yi.sprintf(" class=\"%s\"", e["class"]), l = e.widthUnit,
            ...
            key: "initPagination", value: function () {
                ...
                var o, n, s, l, r, c, d, p = [], u = !1, h = this.getData({includeHiddenRows: !1}),
                    g = a.pageList;
            ...
            key: "initRow", value: function (e, t) {
                ...
                if (!(-1 < yi.findIndex(this.hiddenRows, e))) {
                    ...
                    return n.push("<tr", yi.sprintf(" %s", d.length ? d.join(" ") : void 0), yi.sprintf(" id=\"%s\"", Array.isArray(e) ? void 0 : e._id), yi.sprintf(" class=\"%s\"", i.classes || (Array.isArray(e) ? void 0 : e._class)), " data-index=\"".concat(t, "\""), yi.sprintf(" data-uniqueid=\"%s\"", yi.getItemField(e, this.options.uniqueId, !1)), yi.sprintf(" data-has-detail-view=\"%s\"", !this.options.cardView && this.options.detailView && yi.calculateObjectValue(null, this.options.detailFilter, [t, e]) ? "true" : void 0), yi.sprintf("%s", r), ">"), this.options.cardView && n.push("<td colspan=\"".concat(this.header.fields.length, "\"><div class=\"card-views\">")), !this.options.cardView && this.options.detailView && this.options.detailViewIcon && (n.push("<td>"), yi.calculateObjectValue(null, this.options.detailFilter, [t, e]) && n.push("\n          <a class=\"detail-icon\" href=\"#\">\n          ".concat(yi.sprintf(this.constants.html.icon, this.options.iconsPrefix, this.options.icons.detailOpen), "\n          </a>\n        ")), n.push("</td>")), this.header.fields.forEach(function (a, i) {
                        var r = "", d = yi.getItemField(e, a, o.options.escape), p = "", u = "",
                            h = {}, g = "", f = o.header.classes[i], m = "", b = "", y = "", w = "",
                            S = "", x = o.columns[i];
            ...
            key: "getRowByUniqueId", value: function (e) {
                var t, o, a, n = this.options.uniqueId, s = this.options.data.length, l = e,
                    r = null;
                for (t = s - 1; 0 <= t; t--) {
